        ...
        <div className='grid grid-cols-1 md:flex gap-8 md:gap-5 pt-5 px-[1rem]'>
          {/* Occupational Therapy */}
            <div className=' flex flex-col hvr-float-shadow'>
              <div className=''>
                <Image src='/image/oct1.png' width={400} height={400} alt='image occupation therapy' className='rounded ring-cyan-700 ring hvr-float-shadow' />
                <p className='text-base mt-3 font-bold text-cyan-600/80'>OCCUPATIONAL THERAPY</p>
              </div>
              ...
              <div className='flex flex-col bg-cyan-100 px-3 py-2 rounded bg1'>
                ...
                <p className="mt-2 w-full">
                  <button className='bg-gray-200 hover:bg-cyan-400/40 text-gray-700 hover:text-black cursor-pointer w-fit py-2 px-6 hover:transition-opacity duration-1000 ease-in-out opacity-100 flex items-center gap-2 rounded text-align'>Request a Contract <span><MdArrowOutward /></span></button>
                </p> 
              </div>
            </div>
            ...
            <div className='flex flex-col hvr-float-shadow'>
              <div>
                <Image src='/image/spt.png' width={400} height={400} alt='image speech therapy' className='rounded ring-cyan-700 ring hvr-float-shadow' />
            ...
            <div className='flex flex-col hvr-float-shadow'>
              <div>
                <Image src='/image/pt2.png' width={400} height={400} alt='image occupation therapy' className='rounded ring-cyan-700 ring hvr-float-shadow' />
